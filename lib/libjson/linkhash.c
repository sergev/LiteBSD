...
static u_int32_t hashlittle( const void *key, size_t length, u_int32_t initval)
{
  ...
  if (HASH_LITTLE_ENDIAN && ((u.i & 0x3) == 0)) {
    ...
    const u_int8_t  *k8 = (const u_int8_t *)k;
    switch(length)
    {
    case 12: c+=k[2]; b+=k[1]; a+=k[0]; break;
    case 11: c+=((u_int32_t)k8[10])<<16;  /* fall through */
    case 10: c+=((u_int32_t)k8[9])<<8;    /* fall through */
    case 9 : c+=k8[8];                   /* fall through */
    case 8 : b+=k[1]; a+=k[0]; break;
    case 7 : b+=((u_int32_t)k8[6])<<16;   /* fall through */
    case 6 : b+=((u_int32_t)k8[5])<<8;    /* fall through */
    case 5 : b+=k8[4];                   /* fall through */
    case 4 : a+=k[0]; break;
    case 3 : a+=((u_int32_t)k8[2])<<16;   /* fall through */
    case 2 : a+=((u_int32_t)k8[1])<<8;    /* fall through */
    case 1 : a+=k8[0]; break;
    case 0 : return c;
    }
